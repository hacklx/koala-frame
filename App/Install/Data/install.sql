...
(67, 9, 'Admin/Link/index', '友情连接', '', 1, 0, 0, 1, 1, ''),
(68, 67, 'Admin/Link/add', '新增', '', 1, 0, 0, 1, 1, ''),
(69, 67, 'Admin/Link/edit', '编辑', '', 1, 0, 0, 1, 2, ''),
(70, 67, 'Admin/Link/del', '删除', '', 1, 0, 1, 1, 3, ''),
(71, 9, 'Admin/StoreClass/index', '商铺分类', '', 1, 0, 0, 1, 1, ''),
(72, 71, 'Admin/StoreClass/add', '新增', '', 1, 0, 0, 1, 1, ''),
(73, 71, 'Admin/StoreClass/edit', '编辑', '', 1, 0, 0, 1, 2, ''),
(74, 71, 'Admin/StoreClass/del', '删除', '', 1, 0, 1, 1, 3, '');
...
) ENGINE=MyISAM  DEFAULT CHARSET=utf8 COMMENT='模型字段表' AUTO_INCREMENT=56 ;
