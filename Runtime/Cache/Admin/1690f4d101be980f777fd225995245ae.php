<?php if (!defined('THINK_PATH')) exit();?><div id="ModelField_Bar" class="Bar_tools">
...
<?php if(Is_Auth('Admin/User/add')): ?><a class='easyui-linkbutton' href='JavaScript:void(0);' data-options="iconCls:'iconfont icon-add',plain:true" onclick="Submit_Form('ModelField_Form','ModelField_Data_List','<?php echo U('add',array('model_id' => I ( 'get.model_id' ) ));?>','','新增数据','');"><span>新增</span></a><?php endif; ?>
</div>
...
$(function () {
	$("#ModelField_Data_List").datagrid({
		url : "<?php echo U('Admin/ModelField/index');?>&model_id=<?php echo I('get.model_id');?>&app_id=<?php echo ($app_id); ?>",
		fit : true,
		striped : true,
		border : false,
		pagination : true,
